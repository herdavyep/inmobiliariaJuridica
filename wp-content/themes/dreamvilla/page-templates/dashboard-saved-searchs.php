    ...
    <div class="inner-page-frontend-dashboard">
        <div class="container">
            ...
            if( is_user_logged_in() ){
                get_template_part('inc/frontend/members/dashboard/saved-searches/saved-searches');
            } ?>
        </div>
    </div>
</section>
        ...
        <div class="login-alert">
            <div class="container">
                <div class="panel panel-danger">
                    ...
                    <div class="panel-body"> You need to login to see your saved searches! </div>
                </div>
            </div>
        </div>
    <?php }
