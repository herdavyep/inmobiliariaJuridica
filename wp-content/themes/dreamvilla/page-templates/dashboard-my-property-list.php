<?php
/*
  Template Name: My Property List
*/
    get_header();
    ...
    <div class="inner-page-frontend-dashboard">
        <div class="container">
            ...
            if( is_user_logged_in() ){
                get_template_part('inc/frontend/members/dashboard/my-property-list/my-property-list');
            } ?>            
        </div>
    </div>
</section>
        ...
        <div class="login-alert">
            <div class="container">
                <div class="panel panel-danger">
                    ...
                    <div class="panel-body"> You need to login to see your property list! </div>
                </div>
            </div>
        </div>
    <?php }
