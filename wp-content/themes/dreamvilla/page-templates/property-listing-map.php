			...
			<div class="row">
				...
				<div class="col-md-3">
					<ul class="property-listing-type-button">
						<li><a href="<?php echo esc_url(get_permalink($dreamvilla_options["Theme_Page_Property_Listing_List"])); ?>"><img src="<?php echo get_template_directory_uri();?>/images/list_view_disabled.png" alt="list_view" /></a></li>
						...
						<li><a href="javascript:void(0);" class="active"><img src="<?php echo get_template_directory_uri();?>/images/map_view.png" alt="map_view" /></a></li>
					</ul>
				</div>
			</div>
