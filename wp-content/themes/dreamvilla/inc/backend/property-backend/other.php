<div id="tabs-12" style="border:none;">
	<div class="row">
		...
		<div class="col-sm-4">
			<label for="pnoofgarage"><?php esc_html_e("Numero de garajes","dreamvilla-multiple-property"); ?>: </label>
		</div>
		<div class="col-sm-8">
		...
		<br/>
		<div class="col-sm-4">
			<label for="streetviewlat"><?php esc_html_e("Ingrese latitud","dreamvilla-multiple-property"); ?>: </label>
		</div>
		<div class="col-sm-8">
		...
		<div class="col-sm-4">
			<label for="streetviewlng"><?php esc_html_e("Ingrese latitud","dreamvilla-multiple-property"); ?>: </label>
		</div>
		<div class="col-sm-8">
