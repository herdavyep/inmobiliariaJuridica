...
function dreamvilla_icomoon_composer($settings, $value) {
   
   $out = '<input id="dreamvilla_icomoon_textbox" name="'.$settings['param_name'].'" class="wpb_vc_param_value  '
   .$settings['param_name'].' '.$settings['type'].'_field" type="hidden" value="'
             .$value.'">';
			 
	$out .= "<script>jQuery(document).ready(function() { jQuery('input[name=\"iconfonts_name\"]').click(function(){ jQuery('#dreamvilla_icomoon_textbox').val(jQuery(this).val()) ; });  } );</script>";
   	$out .= '<div id="retinaicon-form" class="dreamvilla-iconfonts-wrapper">
		
	<div class="dreamvilla-icons-list-wrapper">
		<ul class="dreamvilla-icons-list">
	...
	</div><script type="text/javascript">jQuery(document).ready(function(){  var val = jQuery("#dreamvilla_icomoon_textbox").val();  jQuery("#"+val).trigger("click"); });</script>';
	
	return $out;
}

if ( class_exists( 'Vc_Manager' ) ) :
	vc_add_shortcode_param('iconfonts', 'dreamvilla_icomoon_composer');
endif;